...
public class USER_MODEL {
        ...
        private String Nombre,Apellido,Email,Contacto,fecha_nac,estado_civil,sexo,nacionalidad,domicilio,nro_documento,nombrecargo;
    ...
    public USER_MODEL(int id_user, int id_cargo, int id_Docimento, String Nombre, String Apellido, String Email, String Contacto, String fecha_nac, String estado_civil, String sexo, String nacionalidad, String domicilio, String nro_documento, String nombrecargo) {
        this.id_user = id_user;
        this.id_cargo = id_cargo;
        this.id_Docimento = id_Docimento;
        this.Nombre = Nombre;
